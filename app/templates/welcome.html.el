...
% if is_trial then
<p>Мы создали для Вас учётную запись и включили бесплатный 14-дневный пробный период.</p>
% else
<p>Мы создали для Вас учётную запись и подключили бесплатную подписку.</p>
% end

<p>Если Вам не хватает какой-то возможности, нажмите на кнопку "Обратная связь" в редакторе и дайте нам знать.</p>
<p>Мы будем рады улучшить редактор согласно Вашим требованиям!</p>
...
<p>We have created a user account for you and started a free 14-day trial.</p>
% else
<p>We have created a user account for you and activated a free subscription.</p>

% end

<p>If you miss a feature, press "Send feedback" button in the editor and let us know.</p>
<p>We will be happy to add it!</p>
